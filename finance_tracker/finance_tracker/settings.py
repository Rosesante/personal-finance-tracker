...
SECRET_KEY = 'django-insecure-2e0i*^&61fi9^t(kdd5a#o6(_7h)lg)9q_ui%^m7(^z#%2!xny'
...
TRUELAYER_REDIRECT_URI = os.getenv("TRUELAYER_REDIRECT_URI", "http://localhost:8000/bank/callback/")
